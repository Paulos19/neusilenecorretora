...
const DEFAULT_CONNECTIONS: { from: [number, number]; to: [number, number] }[] =
    [
        { from: [-23.55, -46.63], to: [25.20, 55.27] }, // SP to Dubai
        { from: [-23.55, -46.63], to: [48.85, 2.35] },  // SP to Paris
        { from: [-23.55, -46.63], to: [37.78, -122.42] }, // SP to SF
        { from: [48.85, 2.35], to: [25.20, 55.27] }, // Paris to Dubai
        { from: [25.20, 55.27], to: [1.35, 103.82] }, // Dubai to Singapore
        { from: [51.51, -0.13], to: [-23.55, -46.63] }, // London to SP
    ];
...
export function InteractiveGlobe({
    ...
    const draw = useCallback(() => {
        ...
        // Outer glow (subtle white/gray for Neusilene brand)
        ...
        for (const marker of markers) {
            ...
            ctx.strokeStyle = markerColor.replace("1)", `${0.3 + pulse * 0.2})`);
            ctx.lineWidth = 1;
            ctx.stroke();
